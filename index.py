...
class Login(QWidget , login):
    ...
    def Handel_Login(self):
       ...
       # self.cur.execute("INSERT INTO Users VALUES (?,?,?)", (x1, x2, x3,))
       # self.conn.commit()
       # self.cur.close()
        ...
        for row in data  :
            if username == row[1] and password == row[3]:
                ...
                self.label_3.setText('Make Sure You Enterd Your Username And Password Correctly')
...
class MainApp(QMainWindow , ui):
    ...
    def Handel_Day_Operations(self):
        ...
        self.conn = sqlite3.connect("library.db")
        self.cur = self.conn.cursor()
        self.cur.execute("INSERT INTO dayoperations VALUES (NULL,? , ? , ?, ? , ? , ?)", (book_title , type , days_number , today_date ,client_name , to_date,))
    ...
    def Show_All_Operations(self):
        self.conn = sqlite3.connect("library.db")
        self.cur = self.conn.cursor()
        self.cur.execute("SELECT book_name,type,days,date,client,to_date FROM dayoperations")
    ...
    def Search_Books(self):
        ...
        if data:
            ...
            QMessageBox.warning(self, 'Search Books', "Book not Found")
    ...
    def Edit_Books(self):
        ...
        self.cur.execute("UPDATE book SET book_name=? ,book_description=?,book_code=? ,book_category=? ,book_author=? ,book_publisher=? ,book_price=? WHERE book_name =?"
            , (book_title, book_description, book_code, book_category, book_author, book_publisher,
               book_price,search_book_title,))
    ...
    def Delete_Books(self):
        ...
        if warning == QMessageBox.Yes :
            self.cur.execute("DELETE FROM book WHERE book_name =? ", (book_title,))
            self.conn.commit()
    ...
    def Add_New_Client(self):
        ...
        self.conn = sqlite3.connect("Library.db")
        self.cur = self.conn.cursor()
        self.cur.execute("INSERT INTO clients VALUES (NUlL,?,?,?)", (client_name , client_email , client_nationalid,))
        self.conn.commit()
        self.cur.close()
    ...
    def Search_Client(self):
        ...
        self.conn = sqlite3.connect("library.db")
        self.cur = self.conn.cursor()
        self.cur.execute("SELECT * FROM clients WHERE client_nationalid=?", (client_national_id,))
        data = self.cur.fetchone()
        print(data)
        if data:
            ...
            QMessageBox.warning(self, 'Search Clients', "Client not Found")
    ...
    def Delete_Client(self):
        ...
        if warning_message == QMessageBox.Yes :
            ...
            self.cur.execute("DELETE FROM clients WHERE client_nationalid =? ", (client_original_national_id,))
            self.conn.commit()
            self.cur.close()
    ...
    def Add_New_User(self):
        ...
        if password == password2 :
            self.cur.execute("INSERT INTO users VALUES (NULL,? ,?,?)", (username , email , password,))
   ...
   ########################################
    ...
    def Add_Category(self):
        ...
        self.cur.execute("INSERT INTO category VALUES (NULL,?)", (category_name,))
        self.conn.commit()
    ...
    def Add_Author(self):
        ...
        self.cur.execute("INSERT INTO authors VALUES (NULL,?)", (author_name,))
        self.conn.commit()
    ...
    def Add_Publisher(self):
        ...
        self.cur.execute("INSERT INTO publisher VALUES (NULL,?)", (publisher_name,))
   ...
   ########################################
    ...
    def Export_Day_Operations(self):
        ...
        data = self.cur.fetchall()
        wb = Workbook('Export/day_operations.xlsx')
        ...
        wb.close()
        os.system("start EXCEL.EXE Export/day_operations.xlsx")
    ...
    def Export_Books(self):
        ...
        wb = Workbook('Export/all_books.xlsx')
        sheet1 = wb.add_worksheet()
        ...
        wb.close()
        os.system("start EXCEL.EXE Export/all_books.xlsx")
    ...
    def Export_Clients(self):
        ...
        wb = Workbook('Export/all_CLients.xlsx')
        sheet1 = wb.add_worksheet()
        ...
        wb.close()
        os.system("start EXCEL.EXE Export/all_CLients.xlsx")
